...
const stats = { work: 10, travel: 2, total: 12, movementCount: 2, working: 1, travels: 1, time: 4, estimate: { totalMinutes: 4, workMinutes: 3, travelMinutes: 1 }, bounds: { minX: 2, maxX: 40, minY: 3, maxY: 30, minZ: null, maxZ: null } };
